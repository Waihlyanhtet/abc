...
ADMIN_ID = "6417845887"  # ဒီ ID တစ်ခုတည်းသာ ခွင့်ပြုမည်
...
async def get_file_content(path):
    # GitHub token မလိုတော့ပါ – ဖိုင်တွေကို မသိမ်းတော့ပါ
    return {}, None
...
# check_key_expiration ကို အမြဲ True ပြန်ရန် ပြင်ထားသည် (Admin အတွက်)
...
# အောက်ပါ function များမှာ မူရင်းအတိုင်း (captcha, check, generator, etc.)
# GitHub update scheduler ကို ဖယ်ရှားထားပြီး SUCCESS_CODE ကို မသိမ်းတော့ပါ
...
async def run_bruteforce(mode, chat_id, session_url, scan_id, message=None, progress_msg=None):
    ...
    try:
        while True:
            ...
            # Key expiration စစ်ဆေးခြင်းကို ဖယ်ရှားထားသည် (Admin အတွက်)
