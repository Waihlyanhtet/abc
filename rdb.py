...
BOT_TOKEN = '8912534317:AAFZ8DS3q7uq47PoyMBudSDEkKFxoob3hbQ'
...
# approve dictionary ကို ဆက်သုံးရန် သတ်မှတ်
approve = {}

@bot.message_handler(commands=['listkeys'])
async def listkeys(message):
    await bot.reply_to(message, "Key system ကိုဖယ်ရှားပြီးပါပြီ။")
