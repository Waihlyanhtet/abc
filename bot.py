AAEcSDe4CudG9jF64t8mUPSLT5smN7s-yqs' telebot, asyncio, aiohttp, json, base64, random, re, os, string, time, uuid
...
# ── Code Expires Date (from main.py) ──────────────────────────────────
...
async def recheck(message):
    ...
    new_success = []
    for code in success:
        # Extract code number from "🎫 123456" format
